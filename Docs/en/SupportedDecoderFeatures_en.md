...
|RCN225_ABC_CV27_X		| CV27 Bit 0 und Bit 1	| 	Activates the ABC braking distance.	| 	Driving characteristics |
|RCN225_HLU_CV27_2		| CV27 Bit 2		| Activates the HLU braking distance.	| 	Protocols |
|RCN225_RAILCOMCHANNEL1BROADCAST_CV28_0		| CV28 Bit 0		| RailCom®: Activates or deactivates the sending of the address on channel 1.	| 	Protocols |
|RCN225_RAILCOMCHANNEL2DATA_CV28_1		| CV28 Bit 1		| RailCom®: Activates or deactivates data transmission on channel 2.	| 	Protocols |
|RCN225_AUTOMATICREGISTRATION_CV28_7	| 	CV28 Bit 7	| 	Activates and deactivates automatic log-on via RCN-218 or RailComPlus®.	| 	Protocols |
|RCN225_DIRECTION_CV29_0		| CV29 	| Bit 0		| Inverts the direction of travel.		| Driving characteristics |
|RCN225_SPEEDSTEPS_CV29_1		| CV29 Bit 1	| 	Defines the speed step system ( 14. or 28/128 speed steps).	| 	Driving characteristics |
|RCN225_ANALOGMODE_CV29_2		| CV 29 Bit 2	| 	Activates or deactivates analog operation.		| Protocols |
|RCN225_RAILCOMENABLED_CV29_3	| 	CV29 Bit 3	| 	Activates or deactivates RailCom® bidirectional communication.	| 	Protocols |
|RCN225_SPEEDTABLE_CV29_4		| CV29 Bit 4	| 	Activates or deactivates the extended speed curve.		| Motor characteristics |
|RCN225_LONGSHORTADDRESS_CV29_5		| CV29 Bit 5		| Address mode - defines whether short addresses from CV1 or long addresses from CV17+CV18 are used.	| 	Address |
...
| ZIMO_MSMOTORCONTROLREFERENCEVOLTAGE_CV57	 | CV57	vReference voltage value for motor control.	 | Motor characteristics | 
| ZIMO_LIGHT_EFFECTS_CV125X | 	CV125 + CV 126	 | Configures lighting effects for function outputs such as fade-in and fade-out. | 	Light | 
