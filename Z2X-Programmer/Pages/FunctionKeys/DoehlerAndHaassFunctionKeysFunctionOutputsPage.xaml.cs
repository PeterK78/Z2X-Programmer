...
public partial class DoehlerAndHaassFunctionKeysFunctionOutputsPage : ContentPage
{
    public DoehlerAndHaassFunctionKeysFunctionOutputsPage(DoehlerAndHaassFunctionKeysFunctionOutputsViewModel vm)
    {
        InitializeComponent();
        BindingContext = vm;
    }
