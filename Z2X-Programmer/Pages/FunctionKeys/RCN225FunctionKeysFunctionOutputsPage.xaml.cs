...
public partial class RCN225FunctionKeysFunctionOutputsPage : ContentPage
{
    public RCN225FunctionKeysFunctionOutputsPage(RCN225FunctionKeysFunctionOutputsViewModel vm)
    {
        InitializeComponent();
        BindingContext = vm;
    }
