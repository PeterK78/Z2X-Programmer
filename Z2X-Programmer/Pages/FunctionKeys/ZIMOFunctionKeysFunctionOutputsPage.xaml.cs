...
public partial class ZIMOFunctionKeysFunctionOutputsPage : ContentPage
{
    public ZIMOFunctionKeysFunctionOutputsPage(ZIMOFunctionKeysFunctionOutputsViewModel vm)
    {
        InitializeComponent();
        BindingContext = vm;
    }
