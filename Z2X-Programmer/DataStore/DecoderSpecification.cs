    ...
    internal static class DecoderSpecification
    {
        ...
        internal static string DeqSpecName
        {
            ...
            set
            {
                ...
                ZIMO_LIGHT_DIM_CV60 = DeqSpecReader.FeatureSupported(decSpecName, FileAndFolderManagement.DeqSpecReader.ZIMO_LIGHT_DIM_CV60, decSpecFolder); ZIMO_LIGHT_DIM_CV60 = DeqSpecReader.FeatureSupported(decSpecName, FileAndFolderManagement.DeqSpecReader.ZIMO_LIGHT_DIM_CV60, decSpecFolder);
        ...
        //  RCN225
        internal static bool RCN225_MAXIMALSPEED_CV5 { get; set; }
